...
const ContactCta = ({ heading = 'Have a system to build?', description = 'Whether it needs designing from scratch or rescuing from its own success, tell me what you’re building and I’ll tell you how I’d architect it.', className = '' }: ContactCtaProps) => (
  <section className={`pb-16 md:pb-24 ${className}`}>
    <div className="container">
      <div className="bg-default-900 relative overflow-hidden rounded-3xl px-6 py-12 md:px-12 md:py-16 lg:px-16 lg:py-20">
        <span aria-hidden="true" className="bg-primary/20 absolute -top-32 -right-20 size-80 rounded-full blur-3xl" />
        <span aria-hidden="true" className="bg-primary-6/15 absolute -bottom-32 -left-20 size-80 rounded-full blur-3xl" />
