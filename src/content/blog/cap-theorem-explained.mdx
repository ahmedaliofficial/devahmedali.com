...
description: 'CAP theorem is usually taught as an abstract triangle. In production it shows up as one very specific question: what should this service return when it cannot reach the other data centre right now?'
date: '2025-09-03'
