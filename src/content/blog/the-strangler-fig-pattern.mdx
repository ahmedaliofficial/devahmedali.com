...
seoTitle: 'The strangler fig pattern for legacy rewrites'
description: 'A big-bang rewrite bets a new system works before anyone notices the old one stopped. The strangler fig pattern replaces a legacy system piece by piece instead.'
date: '2025-09-12'
