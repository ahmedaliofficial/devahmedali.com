...
description: 'Cron jobs, migrations and reprocessors are all trivial with one replica and dangerous with three. Leader election is the mechanism that lets you run multiple replicas without duplicating the work only one of them should do.'
date: '2025-09-08'
