...
description: 'Attaching a second container to do the job your main service should not have to know about: logging, mTLS, retries, observability. Here is when a sidecar earns its overhead and when it does not.'
date: '2025-08-20'
