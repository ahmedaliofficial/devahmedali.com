...
The most common way a healthy pipeline falls over is that someone adds a call to something slow — a model, a third-party API, an enrichment service — directly inside the consumer.
