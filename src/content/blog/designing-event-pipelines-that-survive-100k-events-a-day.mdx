...
description: 'Throughput is the easy part. The hard part is a consumer restart mid-batch, two replicas double-counting an event, or a slow model call on the ingest path.'
date: '2026-08-14'
